...
async function checkDiscountCodeLimit(shopDomain: string, ipAddress: string): Promise<{
  ...
  console.log('🎮 Checking discount code limit for IP:', ipAddress);
  ...
  console.log('🎮 Settings - maxCodes:', maxCodes, 'resetHours:', resetHours);

  // Get time cutoff (24 hours ago by default)
  const cutoffTime = new Date();
  cutoffTime.setHours(cutoffTime.getHours() - resetHours);
  
  console.log('🎮 Checking codes generated after:', cutoffTime.toISOString());
  ...
  console.log('🎮 Codes used:', codesUsed, '/ max:', maxCodes);
