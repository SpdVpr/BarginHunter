...
export const CURATED_GAMES: ExternalGame[] = [
  {
    id: 'stack-tower',
    name: 'Stack Tower',
    description: 'Break through colorful platforms in this addictive falling ball game',
    category: 'arcade',
    difficulty: 'medium',
    controls: 'Hold to Slow Down',
    sourceUrl: '/games/stack-tower',
    gameType: 'html5',
    author: 'Mobile Games Pro',
    license: 'MIT',
    tags: ['stack', 'ball', 'platforms', 'addictive'],
    minScore: 0,
    maxScore: 100000,
    estimatedPlayTime: 5,
