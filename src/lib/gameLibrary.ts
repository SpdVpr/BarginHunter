...
export const CURATED_GAMES: ExternalGame[] = [
  ...
  },
  {
    ...
    author: 'Bargain Hunter',
    license: 'MIT',
    tags: ['breakout', 'arcade', 'classic', 'paddle'],
    minScore: 0,
    maxScore: 10000,
    estimatedPlayTime: 4,
    mobileCompatible: true,
  ...
  },
  {
    ...
    category: 'action',
    difficulty: 'medium',
    controls: 'Mouse or Arrow Keys + Spacebar',
    sourceUrl: '/games/space-shooter',
    gameType: 'html5',
    author: 'Bargain Hunter',
    license: 'MIT',
    tags: ['space', 'shooter', 'action', 'aliens'],
    minScore: 0,
    maxScore: 50000,
    estimatedPlayTime: 5,
    mobileCompatible: true,
  ...
  },
  {
    id: 'pong-classic',
    name: 'Pong Classic',
    description: 'The original arcade game - beat the AI in this retro classic',
    category: 'retro',
    difficulty: 'easy',
    controls: 'Mouse or Arrow Keys',
    sourceUrl: '/games/pong-classic',
    gameType: 'html5',
    author: 'Bargain Hunter',
    license: 'MIT',
    tags: ['pong', 'retro', 'classic', 'arcade'],
    minScore: 0,
    maxScore: 1600,
    estimatedPlayTime: 3,
    mobileCompatible: true,
